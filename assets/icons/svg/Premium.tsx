...
interface CustomMountainIconProps extends SvgProps {
  fill?: string;
  width?: number;
  height?: number;
}

const CustomMountainIcon: React.FC<CustomMountainIconProps> = ({
  fill = 'white',
  width = 24,
  height = 24,
  ...props
...
export default CustomMountainIcon;
